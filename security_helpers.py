...
def send_real_secure_email(receiver_email: str, token: str):
    ...
    payload = {
        ...
        "subject": "[TEST EMAIL] Verify App Account - Developer Portfolio",
        "htmlContent": f"""
            <div style='background:#f4f4f5; padding:20px;'>
                <p style='color:#b91c1c; font-weight:bold; border: 2px solid #b91c1c; padding: 10px;'>
                ⚠️ DISCLAIMER: This is a test email generated by a university software engineering portfolio project. No real financial data is involved.</p>
...
def send_password_reset_email(receiver_email: str, token: str):
    ...
    payload = {
        "sender": {"name": "Kavinda Portfolio Test", "email": sender_email},
        "to": [{"email": receiver_email}],
        "subject": "[TEST EMAIL] Password Reset - Developer Portfolio",
        "htmlContent": f"""
            <div style='background:#f4f4f5; padding:20px;'>
                <p style='color:#b91c1c; font-weight:bold; border: 2px solid #b91c1c; padding: 10px;'>
...
def send_transfer_otp_email(receiver_email: str, otp: str, amount: str, recipient: str):
    ...
    payload = {
        "sender": {"name": "Kavinda Portfolio Test", "email": sender_email},
        "to": [{"email": receiver_email}],
        "subject": f"[TEST EMAIL] OTP: {otp} - Developer Portfolio",
        "htmlContent": f"""
            <div style='background:#f4f4f5; padding:20px;'>
                <p style='color:#b91c1c; font-weight:bold; border: 2px solid #b91c1c; padding: 10px;'>
                ⚠️ DISCLAIMER: This is a test email generated by a university software engineering portfolio project.</p>
